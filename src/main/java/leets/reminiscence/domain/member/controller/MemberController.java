...
import leets.reminiscence.domain.member.dto.*;
...
public class MemberController {
    ...
    public ResponseEntity getInfo(@Valid @PathVariable("email") String email) throws Exception {
        MemberInfoDto info = memberService.getInfo(email);
