package leets.reminiscence.global.jwt.filter;
...
class JwtAuthenticationFilterTest {
    ...
    private static String USERNAME = "jwnoh@test.net";
    ...
    @BeforeEach
    private void init(){
        memberRepository.save(Member.builder().email(USERNAME).password(delegatingPasswordEncoder.encode(PASSWORD)).username("Member1").role(Role.ROLE_USER).birthday("2023-05-04").build());
        clear();
    }
